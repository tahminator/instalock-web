...
import type { _Response, MetricsCollector } from "../types";
import type {
...
export class RiotClientImpl {
   ...
   */
  static async getUserInfo(authToken: string, collector?: MetricsCollector) {
   ...
   */
  static async getEntitlement(authToken: string, collector?: MetricsCollector) {
    return await withMetrics(
      {
        fnName: "getEntitlement",
        histogram: collector?.histogram,
      },
      async () => {
  ...
  static async getPlayerByPuuid(
    { authToken, entitlementToken, playerPuuids }: PlayerByPuuidRequest,
    collector?: MetricsCollector,
  ) {
    return await withMetrics(
      {
        fnName: "getPlayerByPuuid",
        histogram: collector?.histogram,
      },
      async () => {
        const response = await fetch(
  ...
  static async getPreGameMatchId(
    { authToken, entitlementToken, puuid }: PuuidAuthRequest,
    collector?: MetricsCollector,
  ) {
    return await withMetrics(
      {
        fnName: "getPreGameMatchId",
        histogram: collector?.histogram,
      },
      async () => {
        const response = await fetch(
